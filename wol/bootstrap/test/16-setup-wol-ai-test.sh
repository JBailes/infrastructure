#!/usr/bin/env bash
# 20-setup-wol-ai-test.sh -- Prepare wol-ai-test host environment
#
# Runs on: wol-ai-test (10.0.1.217) -- Debian 13 LXC (privileged)
...
[Unit]
Description=WOL AI Service (test)
...
main() {
    ...
    write_systemd_unit
    configure_firewall
    info "wol-ai-test host environment is ready."
}
